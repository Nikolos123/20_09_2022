...
from library.view_exam import BookViewSet, BookModelViewSet, BookCustomViewSet,FilterBookModelViewSet
...
# from libraty.view_example import  BookListAPIView
from library.view_exam import BookLimitOffsetPaginatonViewSet, BookAPIView, get
...
router.register('book_filter_last', FilterBookModelViewSet)
